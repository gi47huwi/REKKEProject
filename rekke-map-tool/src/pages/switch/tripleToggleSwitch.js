// code from https://codesandbox.io/p/sandbox/react-triple-toggle-forked-lpk2i5?file=%2Fsrc%2Findex.js
    ...
    return (
      <div className="main-container">
        ...
        <label
          ...
          htmlFor="left"
        >
          <h4>{labels.left[this.props.currentLanguage].title}</h4>
        </label>
        ...
        <label
          ...
          htmlFor="right"
        >
          <h4>{labels.right[this.props.currentLanguage].title}</h4>
        </label>
      </div>
    );
  }
